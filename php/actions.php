...
if( !function_exists( 'childtheme_enqueue_styles' ) ) {
	function childtheme_enqueue_styles() {
		...
		wp_enqueue_style( 'main', get_stylesheet_directory_uri() . '/dist/main.css', array(), CHILD_THEME_VERSION );
	}
}
...
if( !function_exists( 'childtheme_enqueue_scripts' ) ) {
	function childtheme_enqueue_scripts() {
		...
		wp_enqueue_script( 'bundle', get_stylesheet_directory_uri() . '/dist/main.js', array( 'jquery' ), CHILD_THEME_VERSION, true );
	}
}
...
if( !function_exists( 'childtheme_utility_widget_areas' ) ) {
	function childtheme_utility_widget_areas() {
		...
		if ( $inside ) {
			$_inside = genesis_get_structural_wrap( 'utility-widgets', 'open' );
			$_inside .= '<div class="row">';
			$_inside .= $inside;
			$_inside .= '</div>';
			$_inside .= genesis_get_structural_wrap( 'utility-widgets', 'close' );
